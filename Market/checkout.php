...
if(isset($_POST['order'])){
   ...
   $address = 'flat no. '. $_POST['flat'] .' '. $_POST['District'] .' '. $_POST['city'] .' '. $_POST['Province'] .' ';
...
<section class="checkout-orders">
   ...
   <form action="" method="POST">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>Address :</span>
            <input type="text" name="flat" placeholder="Home Address" class="box" required>
         </div>
         <div class="inputBox">
            <span>City:</span>
            <input type="text" name="city" placeholder="Malabe" class="box" required>
         </div>
         <div class="inputBox">
            <span>Distric</span>
            <input type="text" name="city" placeholder="colombo" class="box" required>
         </div>
         <div class="inputBox">
            <span>Province :</span>
            <select name="method" class="box" required>
